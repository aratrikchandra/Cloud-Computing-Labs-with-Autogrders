...
# Set a cron job to delete the instructor account and its home directory after 4 hours
echo "sudo userdel -rf instructor" | script -c "/usr/bin/at now + 240 minutes"